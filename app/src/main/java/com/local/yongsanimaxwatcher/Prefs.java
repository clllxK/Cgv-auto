...
public final class Prefs {
    ...
    public boolean isAdjacentSeatOnly(){return p.getBoolean("adjacent_seat_only",false);} public void setAdjacentSeatOnly(boolean v){p.edit().putBoolean("adjacent_seat_only",v).apply();}
